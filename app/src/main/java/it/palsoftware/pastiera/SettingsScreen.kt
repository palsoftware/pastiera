...
sealed class SettingsDestination {
    ...
    object SpeechRecognition : SettingsDestination()
        ...
        when (destination) {
            is SettingsDestination.Main -> {
                SettingsMainScreen(
                    ...
                    onSpeechRecognitionClick = { navigateTo(SettingsDestination.SpeechRecognition) },
            ...
            is SettingsDestination.SpeechRecognition -> {
        ...
        Column(
            ...
            Surface(
                modifier = Modifier
                    .fillMaxWidth()
                    .height(64.dp)
                    .clickable { onSpeechRecognitionClick() }
            ) {
                Row(
                    modifier = Modifier
                        .fillMaxWidth()
